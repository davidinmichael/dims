...
class Account(AbstractUser):
    ...
    level_year = models.IntegerField(choices=StudentLevel.choices, null=True, blank=True)
    current_semester = models.IntegerField(choices=SchoolSemester.choices, null=True, blank=True, default=SchoolSemester.FIRST_SEMESTER)
